...
train_merged['freq_title_sum'] = train_merged.apply(lambda row: find_search_freq_title_desc(row, 'product_title','search_term', 'product_description', mode='title'), axis=1)
train_merged['freq_desc_sum'] = train_merged.apply(lambda row: find_search_freq_title_desc(row, 'product_title','search_term', 'product_description', mode='desc'), axis=1)
